...
<DemoSection
  ...
  classes={['checkbox-wrapper', 'radio-wrapper', 'toggle']}
>
  <div class="grid-3">
    <Card>
      <div class="col" role="group" aria-label="Checkbox">
        <span class="text-xs text-faint uppercase tracking-wide weight-semibold">Checkbox</span>
    ...
    <Card>
      <div class="col" role="group" aria-label="Radio">
        <span class="text-xs text-faint uppercase tracking-wide weight-semibold">Radio</span>
    ...
    <Card>
      <div class="col" role="group" aria-label="Toggle">
        <span class="text-xs text-faint uppercase tracking-wide weight-semibold">Toggle</span>
