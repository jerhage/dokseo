...
describe('fileItemView', () => {
  it('shows the size of a pending file with no state class and a remove action', () => {
  ...
  it('marks a complete file and still shows its size', () => {
  ...
  it('marks a failed file and shows its message in place of its size', () => {
